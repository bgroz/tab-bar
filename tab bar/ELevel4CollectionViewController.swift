...
class ELevel4CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ELevel4CollectionViewController.didTapNext))
...
extension ELevel4CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ELevel4CollectionViewController.didTapCompareButton), for: .touchUpInside)
