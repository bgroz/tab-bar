...
class ALevel5CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ALevel5CollectionViewController.didTapNext))
...
extension ALevel5CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ALevel5CollectionViewController.didTapCompareButton), for: .touchUpInside)
