...
class ILevel3CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ILevel3CollectionViewController.didTapNext))
...
extension ILevel3CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ILevel3CollectionViewController.didTapCompareButton), for: .touchUpInside)
