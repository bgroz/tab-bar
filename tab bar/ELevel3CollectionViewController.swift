...
class ELevel3CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ELevel3CollectionViewController.didTapNext))
...
extension ELevel3CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ELevel3CollectionViewController.didTapCompareButton), for: .touchUpInside)
