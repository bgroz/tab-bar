...
class Level3CollectionViewController: UICollectionViewController , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(Level3CollectionViewController.didTapNext))
...
extension Level3CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(Level3CollectionViewController.didTapCompareButton), for: .touchUpInside)
