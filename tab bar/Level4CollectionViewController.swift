...
class Level4CollectionViewController: UICollectionViewController , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(Level4CollectionViewController.didTapNext))
...
extension Level4CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(Level4CollectionViewController.didTapCompareButton), for: .touchUpInside)
