...
class ILevel1CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ILevel1CollectionViewController.didTapNext))
...
extension ILevel1CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ILevel1CollectionViewController.didTapCompareButton), for: .touchUpInside)
