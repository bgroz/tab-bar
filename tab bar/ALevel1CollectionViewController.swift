...
class ALevel1CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ALevel1CollectionViewController.didTapNext))
...
extension ALevel1CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ALevel1CollectionViewController.didTapCompareButton), for: .touchUpInside)
