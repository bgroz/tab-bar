...
class ALevel2CollectionViewController: UICollectionViewController, UITextFieldDelegate {
...
extension ALevel2CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ALevel2CollectionViewController.didTapCompareButton), for: .touchUpInside)
