...
class ILevel4CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ILevel4CollectionViewController.didTapNext))
...
extension ILevel4CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ILevel4CollectionViewController.didTapCompareButton), for: .touchUpInside)
