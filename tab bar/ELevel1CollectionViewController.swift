...
class ELevel1CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ELevel1CollectionViewController.didTapNext))
...
extension ELevel1CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ELevel1CollectionViewController.didTapCompareButton), for: .touchUpInside)
