...
class Level5CollectionViewController: UICollectionViewController , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(Level5CollectionViewController.didTapNext))
...
extension Level5CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(Level5CollectionViewController.didTapCompareButton), for: .touchUpInside)
