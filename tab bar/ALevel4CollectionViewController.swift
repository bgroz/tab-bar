...
class ALevel4CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ALevel4CollectionViewController.didTapNext))
...
extension ALevel4CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ALevel4CollectionViewController.didTapCompareButton), for: .touchUpInside)
