...
class ILevel5CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ILevel5CollectionViewController.didTapNext))
...
extension ILevel5CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ILevel5CollectionViewController.didTapCompareButton), for: .touchUpInside)
