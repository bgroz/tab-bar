...
class ELevel2CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ELevel2CollectionViewController.didTapNext))
...
extension ELevel2CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ELevel2CollectionViewController.didTapCompareButton), for: .touchUpInside)
