...
class ALevel3CollectionViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(ALevel3CollectionViewController.didTapNext))
...
extension ALevel3CollectionViewController {
    fileprivate func configureViews() {
        ...
        buttonCompare?.addTarget(self, action: #selector(ALevel3CollectionViewController.didTapCompareButton), for: .touchUpInside)
